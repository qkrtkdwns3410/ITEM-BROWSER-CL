...
public class OrdersProductRelation {
    ...
    public static OrdersProductRelation of(OrdersProductRelationRequestDTO ordersProductRelationRequestDTO) {
        if (ordersProductRelationRequestDTO == null) {
            throw new NotFoundException(ErrorCode.ORDER_PRODUCTS_EMPTY);
        }
        
        return OrdersProductRelation.builder()
                .groupId(ordersProductRelationRequestDTO.getGroupId())
                .productId(ordersProductRelationRequestDTO.getProductId())
                .productQuantity(ordersProductRelationRequestDTO.getProductQuantity())
                .product(Product.from(ordersProductRelationRequestDTO.getProductResponseDTO()))
                .build();
    }
}
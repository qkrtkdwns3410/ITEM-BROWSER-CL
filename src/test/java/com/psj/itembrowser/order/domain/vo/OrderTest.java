...
class OrderTest {
	...
	void testCompletePaymentWhenPaymentStatusIsPendingThenPaymentStatusIsCompleteAndPaidDateIsNotNull() {
		// Given
	...
	void testCompletePaymentWhenPaymentStatusIsCompleteThenPaymentStatusIsStillCompleteAndPaidDateIsNull() {
		// Given
